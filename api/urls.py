...
urlpatterns = [
    ...
    path('start-insurance-workflow/', views.start_insurance_workflow, name='start_insurance_workflow'),
    path('insurance-chat/', views.insurance_chat, name='insurance_chat'),
    path('get-insurance-details/', views.get_insurance_details, name='get_insurance_details'),
    ...
    path('auth/clear-all-chats/', views.clear_all_chat_history, name='clear_all_chat_history'),
